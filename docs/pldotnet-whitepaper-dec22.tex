...
The current test passage rate indicates a high degree of primary
compatibility, with the calling of the API, while much work remains in
the smaller details of the API mapping.  We have a long road ahead of us
for the remaining unit tests, but we welcome it.  This path will get us
to not only full compatibility, but strong confidence as an engineering
