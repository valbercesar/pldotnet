...
PL/.NET, also known as _pldotnet_ is a powerful and
...
and triggers on the .NET platform. The development of _pldotnet_ was led
by the team at Brick Abode and was officially released in January 2023.

With _pldotnet_, developers can write code directly in the database
...
the major advantages of _pldotnet_ is its ability to perform complex
...
- PL/.NET supports PostgreSQL 11-17
- PL/.NET supports .NET 9
...
Our white paper, titled "The PL/.NET Extension to PostgreSQL, v0.9",
...
download the white paper directly from the [Brick Abode website](https://brickabode.com/).
