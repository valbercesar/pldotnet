...
_pldotnet_ fully supports 38 PostgreSQL data types via exactly the
...
page here](https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/basic-types).
