...
public abstract class BaseCallUpdateMoneyArrayTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "updateMoneyArray", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "MONEY[]"), new FunctionArgument("desired", "MONEY"), new FunctionArgument("index", "integer[]"), }, ReturnType = "MONEY[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = true, };
    }
    ...
    public void TestCallUpdateMoneyArray(string featureName, string testName, string input, string expectedResult)
    {
