...
public abstract class BaseModifyIntervalTests : PlDotNetTest
{
    ...
    {
        return new object[][]{new object[]{"c#-interval", "modifyInterval1", "INTERVAL '4 hours 5 minutes 6 seconds', 15, 20", "= INTERVAL '1 YEAR 8 MONTHS 15 DAYS 4 HOURS 5 MINUTES 6 SECONDS'"}, new object[]{"c#-interval-null", "modifyInterval2", "NULL::INTERVAL, 15, 20", "= INTERVAL '2 YEAR 40 DAYS 2 HOURS 30 MINUTES'"}, };
    }
...
public class ModifyIntervalTestsCSharp : BaseModifyIntervalTests
{
