...
public abstract class BaseModifyIpCidrTests : PlDotNetTest
{
    ...
    {
        return new object[][]{new object[]{"c#-cidr", "modifyIP_CIDR", "CIDR '192.168/24', 0, 6", "= CIDR '198.168.0.0/24'"}, };
    }
...
public class ModifyIpCidrTestsCSharp : BaseModifyIpCidrTests
{
