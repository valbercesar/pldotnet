...
public abstract class BaseCreateTimestampTzRangeArrayTests : PlDotNetTest
{
    protected abstract string FunctionBody { get; }

    protected abstract LanguageType Language { get; }

    public BaseCreateTimestampTzRangeArrayTests()
    {
        FunctionInfo = new SqlFunctionInfo{Name = "CreateTimestampTzRangeArray", Arguments = new List<FunctionArgument>{}, ReturnType = "TSTZRANGE[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = true, };
    }

    public static object[][] TestCases()
    {
        return new object[][]{new object[]{"c#-tstzrange-null-3array-arraynull", "CreateTimestampTzRangeArray1", "", "= ARRAY[[['[2022-04-14 12:30:25 +00, 2022-04-15 17:30:25 +00)'::TSTZRANGE,'[2022-04-14 12:30:25 +00, 2022-04-15 17:30:25 +00)'::TSTZRANGE], [null::TSTZRANGE, null::TSTZRANGE]], [['[2022-04-14 12:30:25 +00, 2022-04-15 17:30:25 +00)'::TSTZRANGE, null::TSTZRANGE], ['[2022-04-14 12:30:25 +00, 2022-04-15 17:30:25 +00)'::TSTZRANGE, '[2022-04-14 12:30:25 +00, 2022-04-15 17:30:25 +00)'::TSTZRANGE]]]"}, };
    }
...
public class CreateTimestampTzRangeArrayTestsCSharp : BaseCreateTimestampTzRangeArrayTests
{
