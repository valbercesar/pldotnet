...
public abstract class BaseCreateUUIdMultidimensionalArrayTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "CreateUUIdMultidimensionalArray", Arguments = new List<FunctionArgument>{}, ReturnType = "UUID[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = true, };
    }
...
[Trait("Category", "UUId")]
public class CreateUUIdMultidimensionalArrayTestsCSharp : BaseCreateUUIdMultidimensionalArrayTests
{
