...
public abstract class BaseInOutNull3Tests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "InOutNull3", Arguments = new List<FunctionArgument>{new FunctionArgument("OUT argument_0", "INT")}, ReturnType = "", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, };
    }
