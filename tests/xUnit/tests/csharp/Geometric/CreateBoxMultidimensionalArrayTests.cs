...
public abstract class BaseCreateBoxMultidimensionalArrayTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "CreateBoxMultidimensionalArray", Arguments = new List<FunctionArgument>{}, ReturnType = "BOX[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = true, CastFunctionAs = "TEXT", };
    }
...
public class CreateBoxMultidimensionalArrayTestsCSharp : BaseCreateBoxMultidimensionalArrayTests
{
