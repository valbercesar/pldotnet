...
public abstract class BaseIncreaseCidrAddressDllTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "IncreaseCidrAddressDll", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "CIDR[]")}, ReturnType = "CIDR[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, };
    }
