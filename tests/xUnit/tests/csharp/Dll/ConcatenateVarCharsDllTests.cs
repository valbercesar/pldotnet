...
public abstract class BaseConcatenateVarCharsDllTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "ConcatenateVarCharsDll", Arguments = new List<FunctionArgument>{new FunctionArgument("a", "VARCHAR"), new FunctionArgument("b", "VARCHAR"), new FunctionArgument("c", "BPCHAR")}, ReturnType = "VARCHAR", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, };
    }
