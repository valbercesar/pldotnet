...
public abstract class BaseIncreaseInT8RangesDllTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "IncreaseInT8RangesDll", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "INT8RANGE[]")}, ReturnType = "INT8RANGE[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, };
    }
