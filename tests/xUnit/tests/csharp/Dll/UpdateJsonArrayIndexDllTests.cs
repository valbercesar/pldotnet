...
public abstract class BaseUpdateJsonArrayIndexDllTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "UpdateJsonArrayIndexDll", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "JSON[]"), new FunctionArgument("desired", "JSON"), new FunctionArgument("index", "integer[]")}, ReturnType = "JSON[]", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, CastFunctionAs = "TEXT", };
    }
