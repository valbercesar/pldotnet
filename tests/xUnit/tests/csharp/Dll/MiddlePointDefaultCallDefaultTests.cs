...
public abstract class BaseMiddlePointDefaultCallDefaultTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "MiddlePointDefaultCallDefault", Arguments = new List<FunctionArgument>{new FunctionArgument("pointa", "point"), new FunctionArgument("pointb", "point")}, ReturnType = "point", Body = FunctionBody, Language = LanguageType.PlcSharp, IsStrict = false, };
    }
