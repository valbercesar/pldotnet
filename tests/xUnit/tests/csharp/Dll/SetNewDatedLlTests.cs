...
public abstract class BaseSetNewDatedLlTests : PlDotNetTest
{
...
[Trait("Category", "Dll")]
public class SetNewDatedLlTestsCSharp : BaseSetNewDatedLlTests
{
    protected override string FunctionBody => @"
'/app/pldotnet/tests/csharp/DotNetTestProject/bin/Release/CSharpTest.dll:TestDLLFunctions.TestClass!setnewdate'
    ";
