...
public abstract class BaseConcatenateVarBitFsharpTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "ConcatenateVarBitFsharp", Arguments = new List<FunctionArgument>{new FunctionArgument("a BIT", "VARYING"), new FunctionArgument("b BIT", "VARYING")}, ReturnType = "BIT VARYING", Body = FunctionBody, Language = LanguageType.PlfSharp, IsStrict = false, };
    }
