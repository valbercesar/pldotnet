...
public abstract class BaseToggleFirstBitsFsharpTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "ToggleFirstBitsFsharp", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "BIT(8)[]")}, ReturnType = "BIT(8)[]", Body = FunctionBody, Language = LanguageType.PlfSharp, IsStrict = false, };
    }
...
[Trait("Category", "Bit")]
public class ToggleFirstBitsFsharpTestsFSharp : BaseToggleFirstBitsFsharpTests
{
