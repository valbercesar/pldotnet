...
public abstract class BaseModifyStringArrayFsharpDllTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "ModifyStringArrayFsharpDll", Arguments = new List<FunctionArgument>{new FunctionArgument("a", "VARCHAR[]"), new FunctionArgument("b", "TEXT")}, ReturnType = "VARCHAR[]", Body = FunctionBody, Language = LanguageType.PlfSharp, IsStrict = false, };
    }
