...
public abstract class BaseIncreaseBoxSFsharpTests : PlDotNetTest
{
    protected abstract string FunctionBody { get; }

    protected abstract LanguageType Language { get; }

    public BaseIncreaseBoxSFsharpTests()
    {
        FunctionInfo = new SqlFunctionInfo{Name = "IncreaseBoxSFsharp", Arguments = new List<FunctionArgument>{new FunctionArgument("values_array", "BOX[]")}, ReturnType = "BOX[]", Body = FunctionBody, Language = LanguageType.PlfSharp, IsStrict = true, CastFunctionAs = "TEXT", };
    }

    public static object[][] TestCases()
    {
        return new object[][]{new object[]{"f#-box-null-1array", "IncreaseBoxsFSharp1", "ARRAY[BOX(POINT(0.0,1.0),POINT(5.0,3.0)), BOX(POINT(-5.0,4.5),POINT(6.7,12.3)), null::BOX, BOX(POINT(0.0,1.0),POINT(4.7,9.2))]", "= CAST(ARRAY[BOX(POINT(1.0,2.0),POINT(6.0,4.0)), BOX(POINT(-4.0,5.5),POINT(7.7,13.3)), BOX(POINT(1,1),POINT(1,1)), BOX(POINT(1.0,2.0),POINT(5.7,10.2))] AS TEXT)"}, };
    }
...
public class IncreaseBoxSFsharpTestsFSharp : BaseIncreaseBoxSFsharpTests
{
