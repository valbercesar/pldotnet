...
public abstract class BaseCreateTimestampMultidimensionalArrayFsharpTests : PlDotNetTest
{
    ...
    {
        FunctionInfo = new SqlFunctionInfo{Name = "CreateTimestampMultidimensionalArrayFsharp", Arguments = new List<FunctionArgument>{}, ReturnType = "TIMESTAMP[]", Body = FunctionBody, Language = LanguageType.PlfSharp, IsStrict = true, };
    }
...
public class CreateTimestampMultidimensionalArrayFsharpTestsFSharp : BaseCreateTimestampMultidimensionalArrayFsharpTests
{
