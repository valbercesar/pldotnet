...
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'MONEY[]', 'updateMoneyArrayIndex1', updateMoneyArrayIndex(ARRAY['32500.0'::MONEY, '-500.4'::MONEY, null::MONEY, '900540.2'::MONEY], '1390540.2'::MONEY, ARRAY[2]) = ARRAY['32500.0'::MONEY, '-500.4'::MONEY, '1390540.2'::MONEY, '900540.2'::MONEY];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'MONEY[]', 'updateMoneyArrayIndex2', updateMoneyArrayIndex(ARRAY[['32500.0'::MONEY, '-500.4'::MONEY], [null::MONEY, null::MONEY]], '1390540.2'::MONEY, ARRAY[1,0]) = ARRAY[['32500.0'::MONEY, '-500.4'::MONEY], ['1390540.2'::MONEY, null::MONEY]];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'MONEY[]', 'updateMoneyArrayIndex3', updateMoneyArrayIndex(ARRAY[[null::MONEY, null::MONEY], [null::MONEY, null::MONEY]], '1390540.2'::MONEY, ARRAY[1,0]) = ARRAY[[null::MONEY, null::MONEY], ['1390540.2'::MONEY, null::MONEY]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'MONEY[]', 'CreateMoneyMultidimensionalArray1', CreateMoneyMultidimensionalArray() = ARRAY[[[3720368547758.08::MONEY, 3720368547758.08::MONEY], [null::MONEY, null::MONEY]], [[3720368547758.08::MONEY, null::MONEY], [3720368547758.08::MONEY, 3720368547758.08::MONEY]]];
