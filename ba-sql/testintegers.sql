...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'returnSmallIntArray1', returnSmallIntArray(ARRAY[12345::smallint, null::smallint, 123::smallint, 4356::smallint]) = ARRAY[12345::smallint, null::smallint, 123::smallint, 4356::smallint];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'returnSmallIntArray2', returnSmallIntArray(ARRAY[[null::smallint, null::smallint], [12345::smallint, 654::smallint]]) = ARRAY[[null::smallint, null::smallint], [12345::smallint, 654::smallint]];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'returnSmallIntArray3', returnSmallIntArray(ARRAY[[[null::smallint, null::smallint], [null::smallint, null::smallint]], [[186::smallint, 23823::smallint], [9521::smallint, 934::smallint]]]) = ARRAY[[[null::smallint, null::smallint], [null::smallint, null::smallint]], [[186::smallint, 23823::smallint], [9521::smallint, 934::smallint]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'sumSmallIntArray1', sumSmallIntArray(ARRAY[12345::smallint, null::smallint, 123::smallint, 4356::smallint]) = '16824';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'sumSmallIntArray2', sumSmallIntArray(ARRAY[[null::smallint, null::smallint], [12345::smallint, 654::smallint]]) = '12999';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'CreateSmallIntMultidimensionalArray', CreateSmallIntMultidimensionalArray() = ARRAY[[[423::smallint, 536::smallint], [null::smallint, null::smallint]], [[8763::smallint, 15::smallint], [943::smallint, 1003::smallint]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'SMALLINT[]', 'updateArraySmallIntIndex1', updateArraySmallIntIndex(ARRAY[342::smallint, 10456::smallint, null::smallint], CAST(13212 AS smallint), ARRAY[1]) = ARRAY[342::smallint, 13212::smallint, null::smallint];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'returnIntegerArray1', returnIntegerArray(ARRAY[2047483647::integer, null::integer, 304325::integer, 706524::integer]) = ARRAY[2047483647::integer, null::integer, 304325::integer, 706524::integer];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'returnIntegerArray2', returnIntegerArray(ARRAY[[null::integer, null::integer], [2047483647::integer, 304325::integer]]) = ARRAY[[null::integer, null::integer], [2047483647::integer, 304325::integer]];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'returnIntegerArray3', returnIntegerArray(ARRAY[[[null::integer, null::integer], [null::integer, null::integer]], [[2047483647::integer, 304325::integer], [706524::integer, 934::integer]]]) = ARRAY[[[null::integer, null::integer], [null::integer, null::integer]], [[2047483647::integer, 304325::integer], [706524::integer, 934::integer]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'sumIntegerArray1', sumIntegerArray(ARRAY[2047483647::integer, null::integer, 304325::integer, 4356::integer]) = '2047792328';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'sumIntegerArray2', sumIntegerArray(ARRAY[[null::integer, null::integer], [2047483647::integer, 304325::integer]]) = '2047787972';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'CreateIntegerMultidimensionalArray', CreateIntegerMultidimensionalArray() = ARRAY[[[2047483647::integer, 304325::integer], [null::integer, null::integer]], [[706524::integer, 9652345::integer], [943::integer, 4134677::integer]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'INTEGER[]', 'updateArrayIntegerIndex1', updateArrayIntegerIndex(ARRAY[2047483647::integer, 304325::integer, null::integer], 65464532, ARRAY[1]) = ARRAY[2047483647::integer, 65464532::integer, null::integer];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'returnBigIntegerArray1', returnBigIntegerArray(ARRAY[9223372036854775707::bigint, null::bigint, 23372036854775707::bigint, 706524::bigint]) = ARRAY[9223372036854775707::bigint, null::bigint, 23372036854775707::bigint, 706524::bigint];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'returnBigIntegerArray2', returnBigIntegerArray(ARRAY[[null::bigint, null::bigint], [9223372036854775707::bigint, 23372036854775707::bigint]]) = ARRAY[[null::bigint, null::bigint], [9223372036854775707::bigint, 23372036854775707::bigint]];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'returnBigIntegerArray3', returnBigIntegerArray(ARRAY[[[null::bigint, null::bigint], [null::bigint, null::bigint]], [[9223372036854775707::bigint, 23372036854775707::bigint], [706524::bigint, 7563452434247987::bigint]]]) = ARRAY[[[null::bigint, null::bigint], [null::bigint, null::bigint]], [[9223372036854775707::bigint, 23372036854775707::bigint], [706524::bigint, 7563452434247987::bigint]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'sumBigIntegerArray1', sumBigIntegerArray(ARRAY[223372036854775707::bigint, null::bigint, 23372036854775707::bigint, 4356::bigint]) = '246744073709555770';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'CreateBigIntegerMultidimensionalArray', CreateBigIntegerMultidimensionalArray() = ARRAY[[[92232036854775707::bigint, 2337203684775707::bigint], [null::bigint, null::bigint]], [[706524::bigint, 756452434247987::bigint], [943::bigint, 4134677::bigint]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'updateArrayBigIntegerIndex1', updateArrayBigIntegerIndex(ARRAY[92232036854775707::bigint, 2337203684775707::bigint, null::bigint], CAST(67337203684775707 AS BIGINT), ARRAY[1]) = ARRAY[92232036854775707::bigint, 67337203684775707::bigint, null::bigint];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'BIGINT[]', 'updateArrayBigIntegerIndex2', updateArrayBigIntegerIndex(ARRAY[[92232036854775707::bigint, 2337203684775707::bigint], [null::bigint, 12465464::bigint]], CAST(67337203684775707 AS BIGINT), ARRAY[1, 0]) = ARRAY[[92232036854775707::bigint, 2337203684775707::bigint], [67337203684775707::bigint, 12465464::bigint]];
