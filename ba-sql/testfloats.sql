...
SELECT 'FLOAT', 'returnReal', returnReal() = real '1.50055';

CREATE OR REPLACE FUNCTION sumReal(a real, b real) RETURNS real AS $$
return a+b;
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT', 'sumReal', sumReal(1.50055, 1.50054) = real '3.00109'; -- 3.00109
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'DOUBLE', 'returnDouble', returnDouble() = double precision '11.0050000000005';
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'returnRealArray1', returnRealArray(ARRAY[1.50055::real, null::real, 4.52123::real, 7.41234::real]) = ARRAY[1.50055::real, null::real, 4.52123::real, 7.41234::real];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'returnRealArray2', returnRealArray(ARRAY[[null::real, null::real], [4.52123::real, 7.41234::real]]) = ARRAY[[null::real, null::real], [4.52123::real, 7.41234::real]];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'returnRealArray3', returnRealArray(ARRAY[[[null::real, null::real], [null::real, null::real]], [[7.50055::real, 8.30300::real], [9.52123::real, 11.41234::real]]]) = ARRAY[[[null::real, null::real], [null::real, null::real]], [[7.50055::real, 8.30300::real], [9.52123::real, 11.41234::real]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'sumRealArray1', sumRealArray(ARRAY[1.50055::real, 2.30300::real, 4.52123::real, 7.41234::real, null::real]) = '15.737121';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'sumRealArray2', sumRealArray(ARRAY[[1.50055::real, 2.30300::real], [4.52123::real, 7.41234::real], [null::real, null::real]]) = '15.737121';
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'CreateRealMultidimensionalArray', CreateRealMultidimensionalArray() = ARRAY[[[1.24323::real, 3.42345::real], [null::real, null::real]], [[9.32425::real, 8.11134::real], [10.32145::real, 16.14256::real]]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'FLOAT[]', 'updateArrayRealIndex1', updateArrayRealIndex(ARRAY[4.55555::real, 10.11324::real, null::real], 9.83212, ARRAY[1]) = ARRAY[4.55555::real, 9.83212::real, null::real];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'DOUBLE[]', 'returnDoubleArray1', returnDoubleArray(ARRAY[21.0000000000109::double precision, null::double precision, 4.521234313421::double precision, 7.412344328978::double precision]) = ARRAY[21.0000000000109::double precision, null::double precision, 4.521234313421::double precision, 7.412344328978::double precision];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'DOUBLE[]', 'returnDoubleArray2', returnDoubleArray(ARRAY[[null::double precision, null::double precision], [4.521234313421::double precision, 7.412344328978::double precision]]) = ARRAY[[null::double precision, null::double precision], [4.521234313421::double precision, 7.412344328978::double precision]];
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'DOUBLE[]', 'updateArrayDoubleIndex1', updateArrayDoubleIndex(ARRAY[4.55535544213::double precision, 10.1133254154::double precision, null::double precision], 9.8321432132, ARRAY[1]) = ARRAY[4.55535544213::double precision, 9.8321432132::double precision, null::double precision];
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'DOUBLE[]', 'updateArrayDoubleIndex2', updateArrayDoubleIndex(ARRAY[[4.55535544213::double precision, 10.1133254154::double precision], [null::double precision, 16.16155::double precision]], 9.8321432132, ARRAY[1, 0]) = ARRAY[[4.55535544213::double precision, 10.1133254154::double precision], [9.8321432132::double precision, 16.16155::double precision]];
