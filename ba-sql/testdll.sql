...
CREATE OR REPLACE FUNCTION modifyBitDLL(a BIT(10)) RETURNS BIT(10) AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!modifybit' LANGUAGE plcsharp;
...
CREATE OR REPLACE FUNCTION modifyVarbitDLL(a BIT VARYING) RETURNS BIT VARYING AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!modifyvarbit' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION BooleanAndDLL(a boolean, b boolean) RETURNS boolean AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!booleanand' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION byteaConversionsDLL(a BYTEA, b BYTEA) RETURNS BYTEA AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!byteaconversions' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION setNewDateDLL(orig_timestamp TIMESTAMP, new_date DATE) RETURNS TIMESTAMP AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!setnewdate' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
--- FLOAT8
CREATE OR REPLACE FUNCTION sumDoubleArrayDLL(doubles double precision[]) RETURNS double precision AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!sumdoublearray' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION sum2SmallIntDLL(a smallint, b smallint) RETURNS smallint AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!sum2smallint' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!sum2integer' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION sum2BigIntDLL(a bigint, b bigint) RETURNS bigint AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!sum2bigint'
LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
'/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!updatearraypolygonindex' 
...
CREATE OR REPLACE FUNCTION updateJsonArrayIndexDLL(values_array JSON[], desired JSON, index integer[]) RETURNS JSON[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!updatejsonarrayindex' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
--- MONEY Arrays
CREATE OR REPLACE FUNCTION IncreaseMoneyDLL(values_array MONEY[]) RETURNS MONEY[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!increasemoney' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION IncreaseMacAddress8DLL(values_array MACADDR8[]) RETURNS MACADDR8[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!increasemacaddress8' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION IncreaseCIDRAddressDLL(values_array CIDR[]) RETURNS CIDR[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!increasecidraddress' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION IncreaseInt8RangesDLL(values_array INT8RANGE[]) RETURNS INT8RANGE[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!increaseint8ranges' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION IncreaseDateonlyRangesDLL(values_array DATERANGE[]) RETURNS DATERANGE[] AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!increasedateonlyranges' LANGUAGE plcsharp STRICT;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION concatenateVarCharsDLL(a VARCHAR, b VARCHAR, c BPCHAR) RETURNS VARCHAR AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!concatenatevarchars' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
...
CREATE OR REPLACE FUNCTION combineUUIDsDLL(a UUID, b UUID) RETURNS UUID AS '/app/pldotnet/ba-sql/c#_dll_tests_project/bin/Release/net6.0/c#_dll_tests_project.dll:testDLLFunctions.testClass!combineuuids' LANGUAGE plcsharp;
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
