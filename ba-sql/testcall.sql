...
SELECT 'c#-bigint', 'fibonacci2', fibonacci(5) = BIGINT '5';
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
SELECT 'c#-bigint', 'fibonacci3', fibonacci(15) = BIGINT '610';
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
SELECT 'c#-bigint', 'fibonacci1', fibonacci(20) = BIGINT '6765';
INSERT INTO automated_test_results (FEATURE, TEST_NAME, RESULT)
SELECT 'c#-bigint', 'fibonacci1', fibonacci(30) = BIGINT '832040';
