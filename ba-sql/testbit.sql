...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'VARBIT[]', 'updateVarbitArrayIndex1', CAST(updateVarbitArrayIndex(ARRAY['1010101101101'::BIT VARYING, '101011101'::BIT VARYING, null::BIT VARYING, '101001'::BIT VARYING], '1111111001111'::BIT VARYING, ARRAY[2]) AS TEXT) = CAST(ARRAY['1010101101101'::BIT VARYING, '101011101'::BIT VARYING, '1111111001111'::BIT VARYING, '101001'::BIT VARYING] AS TEXT);
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'VARBIT[]', 'updateVarbitArrayIndex2', CAST(updateVarbitArrayIndex(ARRAY[['1010101101101'::BIT VARYING, '101011101'::BIT VARYING], [null::BIT VARYING, '101001'::BIT VARYING]], '1111111001111'::BIT VARYING, ARRAY[1, 0]) AS TEXT) = CAST(ARRAY[['1010101101101'::BIT VARYING, '101011101'::BIT VARYING], ['1111111001111'::BIT VARYING, '101001'::BIT VARYING]] AS TEXT);
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'VARBIT[]', 'updateVarbitArrayIndex3', CAST(updateVarbitArrayIndex(ARRAY[[null::BIT VARYING, null::BIT VARYING], [null::BIT VARYING, '101001'::BIT VARYING]], '1111111001111'::BIT VARYING, ARRAY[1, 0]) AS TEXT) = CAST(ARRAY[[null::BIT VARYING, null::BIT VARYING], ['1111111001111'::BIT VARYING, '101001'::BIT VARYING]] AS TEXT);
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'VARBIT[]', 'ToggleFirstVarbits1', CAST(ToggleFirstVarbits(ARRAY['1010101101101'::BIT VARYING, '101011101'::BIT VARYING, null::BIT VARYING, '001001'::BIT VARYING]) AS TEXT) = CAST(ARRAY['0010101101101'::BIT VARYING, '001011101'::BIT VARYING, null::BIT VARYING, '101001'::BIT VARYING] AS TEXT);
...
$$ LANGUAGE plcsharp STRICT;
INSERT INTO results (FEATURE, TEST_NAME, RESULT)
SELECT 'VARBIT[]', 'CreateVarbitMultidimensionalArray1', CAST(CreateVarbitMultidimensionalArray() AS TEXT) = CAST(ARRAY[[['10101100'::BIT VARYING, '10101100'::BIT VARYING], [null::BIT VARYING, null::BIT VARYING]], [['10101100'::BIT VARYING, null::BIT VARYING], ['10101100'::BIT VARYING, '10101100'::BIT VARYING]]] AS TEXT);
