...
var n = TD.tg_tuples.NEW;
var ol = TD.tg_tuples.OLD;
var x = n.GetInt32(n.GetOrdinal("x")) + 101;
var y = n.GetInt32(n.GetOrdinal("y")) + 102;
var z = n.GetFloat(n.GetOrdinal("z")) + 103.0f;
n.SetInt32(n.GetOrdinal("x"), x);
n.SetInt32(n.GetOrdinal("y"), y);
n.SetFloat(n.GetOrdinal("z"), z);
return "MODIFY";
$$ LANGUAGE plcsharp;
--
-- create a new trigger to call the
...
var new_tuple = TD.tg_tuples.NEW;
return new_tuple.GetInt32(new_tuple.GetOrdinal("x")) == 1 ? "SKIP" : null;
$$ LANGUAGE plcsharp;
--
...
var new_tuple = TD.tg_tuples.NEW;
return new_tuple.GetInt32(new_tuple.GetOrdinal("x")) == (int) 1 ? "SKIP" : null;
$$ LANGUAGE plcsharp;
--
...
bool old_y_is_5 = (int) TD.tg_tuples.OLD.GetValue("y") == (int) 5;
bool new_x_is_3 = (int) TD.tg_tuples.NEW.GetValue("x") == (int) 3;
...
SELECT 0 = COUNT(*) FROM my_table WHERE x = 0 AND y = 5 AND z = 6;
--
...
bool name = TD.tg_name.Contains("accesstriggervariables");
bool table_schema = "public" == TD.tg_table_schema;
bool table_name = "my_table" == TD.tg_table_name;
bool is_row = "ROW" == TD.tg_level;
bool is_before = "BEFORE" == TD.tg_when;
bool insertion = "INSERT" == TD.tg_event;
...
{
    var new_tuple = TD.tg_tuples.NEW;
    var pos = new_tuple.GetOrdinal("x");
    var value = new_tuple.GetInt32(pos);
    if (insertion)
    {
        return value != 0 ? null : "SKIP";
    }
    else
    {
        new_tuple.SetInt32(pos, value + 100);
        return "MODIFY";
    }
}
else
