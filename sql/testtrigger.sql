...
bool name = TD.name.Contains("accesstriggervariables");
bool table_schema = "public" == TD.table_schema;
bool table_name = "my_table" == TD.table_name;
bool is_row = "ROW" == TD.level;
bool is_before = "BEFORE" == TD.when;
