...
$$ LANGUAGE plfsharp;
--
CREATE TRIGGER accessTriggerVariablesBeforeInsertFSharp
BEFORE INSERT ON my_table
FOR EACH ROW EXECUTE PROCEDURE accessTriggerVariablesFSharp();
--
CREATE TRIGGER accessTriggerVariablesAfterInsertFSharp
AFTER INSERT ON my_table
FOR EACH ROW EXECUTE PROCEDURE accessTriggerVariablesFSharp();
--
CREATE TRIGGER accessTriggerVariablesBeforeUpdateFSharp
BEFORE UPDATE ON my_table
FOR EACH ROW EXECUTE PROCEDURE accessTriggerVariablesFSharp();
--
CREATE TRIGGER accessTriggerVariablesAfterUpdateFSharp
AFTER UPDATE ON my_table
FOR EACH ROW EXECUTE PROCEDURE accessTriggerVariablesFSharp();
--
TRUNCATE TABLE my_table;
...
--
DROP TRIGGER accessTriggerVariablesBeforeInsertFSharp ON my_table;
...
| None -> None
| Some relatts ->
    match Array.contains "x" relatts with
    | true -> None
    | false -> Some "SKIP"
$$ LANGUAGE plfsharp;
--
CREATE TRIGGER accessTriggerRelattsFSharp
BEFORE INSERT ON my_table
FOR EACH ROW EXECUTE PROCEDURE accessTriggerRelattsFSharp();
--
TRUNCATE TABLE my_table;
TRUNCATE TABLE update_events;
--
...
EXECUTE verify_entries(:entries_quantity, :offset_x, :offset_y, :offset_z);
--
DROP TRIGGER accessTriggerRelattsFSharp ON my_table;
--
------------------- ACCESS TRIGGER RELATTS -----------------------
------------------------------------------------------------------
--
