...
SELECT
    'maxSmallInt',
    plbench('SELECT maxSmallInt()', :runs) as pldotnet,
...
SELECT
    'sum2SmallInt',
    plbench('SELECT sum2SmallInt(CAST(100 AS smallint), CAST(101 AS smallint))', :runs) as pldotnet,
...
SELECT
    'maxInteger',
    plbench('SELECT maxInteger()', :runs) as pldotnet,
...
SELECT
    'sum2Integer',
    plbench('SELECT sum2Integer(32770, 100)', :runs) as pldotnet,
...
SELECT
    'maxBigInt',
    plbench('SELECT maxBigInt()', :runs) as pldotnet,
...
SELECT
    'sum2BigInt',
    plbench('SELECT sum2BigInt(9223372036854775707, 100)', :runs) as pldotnet,
...
SELECT
    'mixedBigInt',
    plbench('SELECT mixedBigInt(32767,  2147483647, 100)', :runs) as pldotnet,
...
SELECT
    'mixedInt',
    plbench('SELECT mixedInt(CAST(32767 AS smallint),  CAST(32767 AS smallint), 100)', :runs) as pldotnet,
